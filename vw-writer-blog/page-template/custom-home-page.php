        ...
        <div <?php if($i == 1){echo 'class="carousel-item active"';} else{ echo 'class="carousel-item"';}?>>
          ...
          <div class="carousel-caption">
            <div class="inner_carousel">
              ...
              <h2><?php the_title(); ?></h2>
              <p><?php $excerpt = get_the_excerpt(); echo esc_html( vw_writer_blog_string_limit_words( $excerpt,30 ) ); ?></p>
              <div class="more-btn">              
...
<section id="articles">
  <div class="container">
    <?php if( get_theme_mod('vw_writer_blog_section_title') != ''){ ?>
      <h3><i class="fas fa-edit"></i><?php echo esc_html(get_theme_mod('vw_writer_blog_section_title','')); ?></h3>
    <?php }?>
    <div class="row">
      <?php
